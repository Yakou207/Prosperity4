...
class ConversionObservation:
    ...
    def __init__(self, bidPrice: float, askPrice: float, transportFees: float, exportTariff: float, importTariff: float, sunlight: float = 0, humidity: float = 0):
...
class Observation:
    ...
    def __init__(self, plainValueObservations: Dict[Product, ObservationValue] = None, conversionObservations: Dict[Product, ConversionObservation] = None) -> None:
